        ...
        for(int i = 0; i<MaxParticlesRain; i++){
            ...
            if(p.life > 0.0f){
                ...
                if (p.life > 0.0f){
                    ...
                    if (p.pos.y < -3.5f){
                        g_particule_position_size_data_rain[4*ParticlesCountRain+0] = -10.f;
                        g_particule_position_size_data_rain[4*ParticlesCountRain+1] = -10.f;
                        g_particule_position_size_data_rain[4*ParticlesCountRain+2] = -10.f;    
                    }
                    else {
