...
int main( void )
{
    ...
    do {
        ...
        int newparticles = CurrentParticles/ (int)(3.5f/delta);
        if (newparticles > (int)(0.016f*10000.0))
            newparticles = (int)(0.016f*10000.0);
        
        for (int i = 0; i < newparticles; i++){
            int particleIndex = FindUnusedParticle();
            ParticlesContainer[particleIndex].life = 3.5f; // This particle will live 5 seconds.
            ParticlesContainer[particleIndex].pos = glm::vec3((rand()%2000)*0.01f-10.0f,15.0f,-20.0f);
        ...
        countParticles += newparticles;
        if (countParticles >= CurrentParticles - 30){
            CurrentParticles = rand()%2001;
        } 
